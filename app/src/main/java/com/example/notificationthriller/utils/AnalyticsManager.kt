...
class AnalyticsManager(context: Context) {
    ...
    fun logMessageRead(messageId: Int, sender: String) {
        val bundle = Bundle().apply {
    ...
    fun logChoiceMade(messageId: Int, choiceId: Int, choiceText: String) {
        val bundle = Bundle().apply {
            putInt("message_id", messageId)
    ...
    fun logPurchaseSuccess(productId: String, price: Double) {
        val bundle = Bundle().apply {
            putString("product_id", productId)
