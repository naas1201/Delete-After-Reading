package com.notificationthriller.app.engine
...
class ChoiceEngine(private val context: Context) {
     ...
     */
    private fun analyzeChoiceImpact(
        messageId: Int,
        choiceId: Int,
        choiceText: String,
    ): ChoiceImpact {
