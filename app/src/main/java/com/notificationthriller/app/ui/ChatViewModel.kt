...
import com.notificationthriller.app.data.*
import com.notificationthriller.app.engine.ChoiceEngine
import com.notificationthriller.app.workers.MessageNotificationWorker
...
class ChatViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun scheduleNotifications(messages: List<Message>) {
        ...
        messages.forEach { message ->
            ...
            val notificationWork =
                OneTimeWorkRequestBuilder<MessageNotificationWorker>()
    ...
    fun selectChoice(
        ...
        viewModelScope.launch {
            ...
            val currentStoryState =
                database.storyStateDao().getStoryStateOnce()
                    ?: StoryState(id = 1)

            // Process choice through the choice engine
            val result =
                choiceEngine.processChoice(
                    messageId = messageId,
                    choiceId = choiceId,
     ...
     */
    private fun generateChoiceImpactSummary(result: com.notificationthriller.app.engine.ChoiceResult): String {
